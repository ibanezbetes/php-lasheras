-- ========================================================
-- BASE DE DATOS COMPLETA PARA DESPLIEGUE EN EC2 (AWS)
-- Generado el: 2026-03-24 10:31:42
-- ========================================================

SET FOREIGN_KEY_CHECKS = 0;

-- --------------------------------------------------------
-- INCLUYENDO: sql-new/usuarios y productos 2025 09 29.sql
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- INCLUYENDO: sql/crear_menus_y_pedidos.sql
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- INCLUYENDO: sql/reemplazar_productos_informatica.sql
-- --------------------------------------------------------
...
INSERT INTO `productos` (`idProducto`, `producto`, `descripcion`, `idCategoria`, `stock`, `precioCompra`, `precioVenta`, `stockMinimo`, `activo`) VALUES
(1, 'Procesador AMD Ryzen 7 7800X3D', 'Procesador AM5 de 8 núcleos, perfecto para gaming', 1, 15, 300.00, 389.90, 5, 'S'),
(2, 'Procesador Intel Core i5-13600K', 'Procesador LGA1700 de 14 núcleos (6P+8E)', 1, 20, 250.00, 319.50, 5, 'S'),
(3, 'Placa Base ASUS ROG Strix B650E-F', 'Placa base ATX AM5 con WiFi 6E y PCIe 5.0', 1, 10, 200.00, 275.99, 5, 'S'),
(4, 'Placa Base MSI MAG B760 TOMAHAWK', 'Placa base ATX LGA1700, DDR5, WiFi 6', 1, 12, 150.00, 199.90, 5, 'S'),
(5, 'Memoria RAM Corsair Vengeance RGB 32GB', 'Kit DDR5 (2x16GB) 6000MHz CL30', 1, 25, 100.00, 134.99, 5, 'S'),
(6, 'Memoria RAM Kingston FURY Beast 16GB', 'Módulo DDR4 3200MHz CL16', 1, 40, 30.00, 45.99, 5, 'S'),
(7, 'Tarjeta Gráfica NVIDIA RTX 4070 SUPER', 'GPU de 12GB GDDR6X, DLSS 3, 3 ventiladores', 1, 8, 550.00, 659.90, 5, 'S'),
(8, 'Tarjeta Gráfica AMD Radeon RX 7800 XT', 'GPU de 16GB GDDR6, ideal para 1440p', 1, 10, 450.00, 539.90, 5, 'S'),
(9, 'Disco SSD M.2 Samsung 990 PRO 2TB', 'SSD NVMe PCIe 4.0 con velocidades hasta 7450 MB/s', 1, 30, 140.00, 189.99, 5, 'S'),
(10, 'Disco SSD M.2 WD Blue SN580 1TB', 'SSD NVMe PCIe 4.0 económico y rápido', 1, 45, 50.00, 69.90, 5, 'S'),
(11, 'Fuente de Alimentación Corsair RM850x', 'Fuente de 850W, 80 Plus Gold, Modular', 1, 15, 110.00, 149.90, 5, 'S'),
(12, 'Refrigeración Líquida MSI MAG CoreLiquid 360R', 'AIO de 360mm con RGB, socket universal', 1, 18, 90.00, 115.50, 5, 'S'),
(13, 'Disipador Noctua NH-D15 chromax.black', 'Disipador de aire premium de doble torre', 1, 14, 90.00, 119.90, 5, 'S'),
(14, 'Caja Phanteks Eclipse G360A Mid-Tower', 'Caja ATX con frontal mallado y 3 ventiladores D-RGB', 1, 20, 70.00, 99.90, 5, 'S'),
(15, 'Monitor LG UltraGear 27GP850-B', 'Monitor Gaming 27p Nano IPS, 1440p, 165Hz, 1ms', 1, 12, 250.00, 329.00, 5, 'S'),
(16, 'Ratón Logitech G Pro X Superlight', 'Ratón inalámbrico ultraligero para eSports', 1, 22, 90.00, 125.99, 5, 'S'),
(17, 'Ratón Razer DeathAdder V3 Pro', 'Ratón ergonómico inalámbrico, sensor óptico de 30K', 1, 15, 110.00, 145.50, 5, 'S'),
(18, 'Teclado Mecánico Corsair K70 RGB PRO', 'Teclado completo con switches Cherry MX Red', 1, 10, 130.00, 169.90, 5, 'S'),
(19, 'Teclado Mecánico Keychron K8 Pro', 'Teclado custom TKL, Bluetooth/Cable, Hot-Swappable', 1, 18, 90.00, 119.00, 5, 'S'),
(20, 'Auriculares HyperX Cloud III Wireless', 'Auriculares gaming inalámbricos con autonomía de 120h', 1, 25, 100.00, 139.99, 5, 'S');
...
-- --------------------------------------------------------
-- INCLUYENDO: sql/permisos_setup.sql
-- --------------------------------------------------------
